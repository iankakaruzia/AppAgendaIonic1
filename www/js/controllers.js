...
.controller('agendaCtrl', ['$scope', '$stateParams', '$ionicModal', 'agendaApi', function ($scope, $stateParams, $ionicModal, agendaApi) {
	var contatos = [];
...
.controller('sobreCtrl', ['$scope', '$stateParams', function ($scope, $stateParams) {
